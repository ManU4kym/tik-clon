    ...
    <div id="TopNav" class="fixed bg-white z-30 flex items-center w-full border-b h-[61px]">
        <div :class="route.fullPath === '/' ? 'max-w-[1150px]' : ''"
            ...
            <div :class="route.fullPath === '/' ? 'w-[80%]' : 'lg:w-[20%] w-[70%]'">
                <nuxt-link to="/" class="flex justify-start ">
                    <img src="https://cdn-icons-png.freepik.com/256/2549/2549120.png?semt=ais_hybrid" alt="Logo"
                          class="h-[38px] w-[38px] " />
                </nuxt-link>
            </div>
            ...
            <div class="flex items-center justify-end gap-3 min-w-[275px] max-w-[320px] w-full">
                ...
                <div class="flex items-center">
                    <Icon class="ml-1 mr-4" name="carbon:send-alt" color="#161724" size="25"/>
                    <Icon class="mr-5" name="bx:message-detail" color="#161724" size="25"/>
                    <div class="relative">
                        <button class="mt-1">
                            <img @click="showMenu = !showMenu" src="https://img.freepik.com/free-photo/3d-render-vs-company-metal-letter-logo-pen-tool-created-clipping-path-included-jpeg-easy-composite_460848-7192.jpg?ga=GA1.1.2111888000.1736886517&semt=ais_hybrid" alt="profile" class="rounded-full h-[38px] w-[48px] "  >
                        </button>

                        <div v-if="showMenu" id="popupmenu" class="absolute bg-white rounded-lg py-1.5 w-[200px] shadow-xl border top-[43px] -right-2">
                            <nuxt-link @click="$event => showMenu = false" to="" class="flex items-center justify-start py-3 px-2 hover:bg-gray-100 cursor-pointer">
                                <Icon name="uil:user" size="20"/>
                                <span class="pl-2 font-semi bold text-sm">Profile</span>
                            </nuxt-link>
                            ...
                            <div  class="flex items-center justify-start py-3 px-1.5 hover:bg-gray-100 border-t cursor-pointer">
                                ...
                                <span class="pl-2 font-semi bold text-sm">Logout</span>
                            </div>
                        </div>
                    </div>
                </div>
